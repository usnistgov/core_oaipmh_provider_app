...
urlpatterns = [
    ...
    re_path(r'^XSD/(?P<title>.*)/(?:(?P<version_number>\d+)/)$(?i)', get_xsd, name="core_oaipmh_provider_app_get_xsd"),
    re_path(r'^', OAIProviderView.as_view(), name="core_oaipmh_provider_app_server_index"),
]
