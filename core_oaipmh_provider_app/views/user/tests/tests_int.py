...
from core_oaipmh_provider_app.views.user.tests.fixtures.fixtures import OaiPmhFixtures
...
class TestVerbs(TestOaiPmhSuite, MongoIntegrationBaseTestCase):
    ...
    def test_identify(self):
        ...
        # Act
        response = RequestMock.do_request_get(OAIProviderView.as_view(), user=None, data=data)
    ...
    def test_get_list_metadata_formats(self, mock_get_metadata_format_schema_url):
        ...
        self.check_tag_count(response.rendered_content, 'metadataFormat', len(self.fixture.oai_metadata_formats))
